...
knitr::opts_chunk$set(warning=FALSE, message=FALSE, cache=FALSE, 
               comment=NA, verbose=TRUE, fig.width=10, fig.height=10, dev='jpeg',dev.args=list(quality=100))
```
...
EqualizePiecewise(g, 3) %>% plot(main = "EqualizePiecewise")
...
If you have an idea, let me know by making a issue in [github](https://github.com/ShotaOchi/imagerExtra/issues).
